...
const Layout = ({ children }: Props) => {
  ...
  return (
    <main className="w-screen h-screen overflow-y-hidden">
      ...
      <section className="max-w-2xl mx-auto h-full items-center align-middle lg:min-w-[50rem] md:min-w-[30rem] px-5 md:px-20 lg:px-44">
      ...
      <footer className="absolute bottom-0 w-screen">
        <div className="bg-transparent md:bg-[#f3e858] lg:bg-[#f3e858] text-[#000000]">
          <Footer
